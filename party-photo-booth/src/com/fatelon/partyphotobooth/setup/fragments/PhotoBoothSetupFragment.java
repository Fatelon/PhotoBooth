...
import com.fatelon.partyphotobooth.setup.model.PhotoBoothModeAdapter;
import com.fatelon.partyphotobooth.setup.model.PhotoStripTemplateAdapter;
import com.groundupworks.partyphotobooth.R;
import com.fatelon.partyphotobooth.setup.model.PhotoBoothThemeAdapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mMode.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                PreferencesHelper.PhotoBoothMode selectedMode = modeAdapter.getPhotoBoothMode(position);
        ...
        mTheme.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                PreferencesHelper.PhotoBoothTheme selectedTheme = themeAdapter.getPhotoBoothTheme(position);
        ...
        mTemplate.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                PreferencesHelper.PhotoStripTemplate selectedTemplate = templateAdapter.getPhotoStripTemplate(position);
