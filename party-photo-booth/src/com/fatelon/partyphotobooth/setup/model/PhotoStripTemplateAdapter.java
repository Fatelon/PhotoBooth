...
/**
 * Adapter for the {@link PreferencesHelper.PhotoStripTemplate} selection ui.
 *
 * @author Benedict Lau
 */
public class PhotoStripTemplateAdapter extends BaseSpinnerAdapter<PhotoStripTemplateAdapter.Template> {
    ...
    private static SparseArray<PhotoStripTemplateAdapter.Template> createItems(Context context) {
        ...
        single.mTemplate = PreferencesHelper.PhotoStripTemplate.SINGLE;
        ...
        modes.put(PreferencesHelper.PhotoStripTemplate.SINGLE.ordinal(), single);

        // Add Vertical 2.
        PhotoStripTemplateAdapter.Template vertical2 = new PhotoStripTemplateAdapter.Template();
        vertical2.mTemplate = PreferencesHelper.PhotoStripTemplate.VERTICAL_2;
        ...
        modes.put(PreferencesHelper.PhotoStripTemplate.VERTICAL_2.ordinal(), vertical2);

        // Add Horizontal 2.
        PhotoStripTemplateAdapter.Template horizontal2 = new PhotoStripTemplateAdapter.Template();
        horizontal2.mTemplate = PreferencesHelper.PhotoStripTemplate.HORIZONTAL_2;
        ...
        modes.put(PreferencesHelper.PhotoStripTemplate.HORIZONTAL_2.ordinal(), horizontal2);

        // Add Vertical 3.
        PhotoStripTemplateAdapter.Template vertical3 = new PhotoStripTemplateAdapter.Template();
        vertical3.mTemplate = PreferencesHelper.PhotoStripTemplate.VERTICAL_3;
        ...
        modes.put(PreferencesHelper.PhotoStripTemplate.VERTICAL_3.ordinal(), vertical3);

        // Add Horizontal 3.
        PhotoStripTemplateAdapter.Template horizontal3 = new PhotoStripTemplateAdapter.Template();
        horizontal3.mTemplate = PreferencesHelper.PhotoStripTemplate.HORIZONTAL_3;
        ...
        modes.put(PreferencesHelper.PhotoStripTemplate.HORIZONTAL_3.ordinal(), horizontal3);

        // Add Vertical 4.
        PhotoStripTemplateAdapter.Template vertical4 = new PhotoStripTemplateAdapter.Template();
        vertical4.mTemplate = PreferencesHelper.PhotoStripTemplate.VERTICAL_4;
        ...
        modes.put(PreferencesHelper.PhotoStripTemplate.VERTICAL_4.ordinal(), vertical4);

        // Add Horizontal 4.
        PhotoStripTemplateAdapter.Template horizontal4 = new PhotoStripTemplateAdapter.Template();
        horizontal4.mTemplate = PreferencesHelper.PhotoStripTemplate.HORIZONTAL_4;
        ...
        modes.put(PreferencesHelper.PhotoStripTemplate.HORIZONTAL_4.ordinal(), horizontal4);

        // Add Box 4.
        PhotoStripTemplateAdapter.Template box4 = new PhotoStripTemplateAdapter.Template();
        box4.mTemplate = PreferencesHelper.PhotoStripTemplate.BOX_4;
        ...
        modes.put(PreferencesHelper.PhotoStripTemplate.BOX_4.ordinal(), box4);
    ...
    /**
     * Gets the {@link PreferencesHelper.PhotoStripTemplate} based on the item position.
     *
     * @param position position of the item whose data we want within the adapter's data set.
     * @return the {@link PreferencesHelper.PhotoStripTemplate}.
     */
    public PreferencesHelper.PhotoStripTemplate getPhotoStripTemplate(int position) {
    ...
    /**
     * An internal model object used by the adapter representing a {@link PreferencesHelper.PhotoStripTemplate} and its data for the
     * selection ui.
     */
    static class Template {

        /**
         * The {@link PreferencesHelper.PhotoStripTemplate}.
         */
        private PreferencesHelper.PhotoStripTemplate mTemplate;

        /**
         * The display name for the {@link PreferencesHelper.PhotoStripTemplate}.
         */
        private String mDisplayName;

        /**
         * The description of the {@link PreferencesHelper.PhotoStripTemplate}.
         */
