...
/**
 * Adapter for the {@link PreferencesHelper.PhotoBoothMode} selection ui.
 *
 * @author Benedict Lau
 */
public class PhotoBoothModeAdapter extends BaseSpinnerAdapter<PhotoBoothModeAdapter.Mode> {
    ...
    private static SparseArray<PhotoBoothModeAdapter.Mode> createItems(Context context) {
        ...
        selfServeMode.mMode = PreferencesHelper.PhotoBoothMode.SELF_SERVE;
        ...
        modes.put(PreferencesHelper.PhotoBoothMode.SELF_SERVE.ordinal(), selfServeMode);

        // Add automatic mode.
        PhotoBoothModeAdapter.Mode automaticMode = new PhotoBoothModeAdapter.Mode();
        automaticMode.mMode = PreferencesHelper.PhotoBoothMode.AUTOMATIC;
        ...
        modes.put(PreferencesHelper.PhotoBoothMode.AUTOMATIC.ordinal(), automaticMode);

        // Add photographer mode.
        PhotoBoothModeAdapter.Mode photographerMode = new PhotoBoothModeAdapter.Mode();
        photographerMode.mMode = PreferencesHelper.PhotoBoothMode.PHOTOGRAPHER;
        ...
        modes.put(PreferencesHelper.PhotoBoothMode.PHOTOGRAPHER.ordinal(), photographerMode);
    ...
    /**
     * Gets the {@link PreferencesHelper.PhotoBoothMode} based on the item position.
     *
     * @param position position of the item whose data we want within the adapter's data set.
     * @return the {@link PreferencesHelper.PhotoBoothMode}.
     */
    public PreferencesHelper.PhotoBoothMode getPhotoBoothMode(int position) {
    ...
    /**
     * An internal model object used by the adapter representing a {@link PreferencesHelper.PhotoBoothMode} and its data for the selection
     * ui.
     */
    static class Mode {

        /**
         * The {@link PreferencesHelper.PhotoBoothMode}.
         */
        private PreferencesHelper.PhotoBoothMode mMode;

        /**
         * The display name for the {@link PreferencesHelper.PhotoBoothMode}.
         */
        private String mDisplayName;

        /**
         * The description of the {@link PreferencesHelper.PhotoBoothMode}.
         */
